...
> = {
  import:       { labelKey: "registry.opImport",       color: "#4aa3ff", bg: "rgba(74,163,255,0.12)",  border: "rgba(74,163,255,0.28)" },
  export:       { labelKey: "registry.opExport",       color: "#8fa8c6", bg: "rgba(143,168,198,0.08)", border: "rgba(143,168,198,0.18)" },
  merge:        { labelKey: "registry.opMerge",        color: "#f2b66d", bg: "rgba(242,182,109,0.12)", border: "rgba(242,182,109,0.28)" },
  "add-node":   { labelKey: "registry.opAddNode",     color: "#4cc38a", bg: "rgba(76,195,138,0.12)",  border: "rgba(76,195,138,0.28)" },
  "update-node": { labelKey: "registry.opUpdateNode",  color: "#79c0ff", bg: "rgba(121,192,255,0.10)", border: "rgba(121,192,255,0.24)" },
  "add-edge":   { labelKey: "registry.opAddEdge",     color: "#4cc38a", bg: "rgba(76,195,138,0.10)",  border: "rgba(76,195,138,0.22)" },
  delete:       { labelKey: "registry.opDelete",       color: "#ff7b72", bg: "rgba(255,123,114,0.12)", border: "rgba(255,123,114,0.28)" },
  infer:        { labelKey: "registry.opInfer",        color: "#d2a8ff", bg: "rgba(210,168,255,0.12)", border: "rgba(210,168,255,0.28)" },
  "vocab-import": { labelKey: "registry.opVocabImport",      color: "#79c0ff", bg: "rgba(121,192,255,0.12)", border: "rgba(121,192,255,0.28)" },
};
      ...
      <div style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
        ...
        {hasDetail ? (
          <button
            ...
            title={expanded ? t('registry.collapseDetails') : t('registry.expandDetails')}
      ...
      <div style={headerStyle}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          <span style={{ color: "#8fa8c6", fontSize: 12 }}>
            {t('registry.eventCount', { count: entries.length })}
          </span>
          {entries.length > 0 ? (
            <button
            ...
            >
              <Trash2 size={13} />
              <span>{t('registry.clearButton')}</span>
            </button>
          ) : null}
        </div>
      </div>
        ...
        <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
          {ALL_OPS.map((op) => {
            ...
            return (
              ...
              >
                {op === "all" ? t("registry.opAll") : (meta ? t(meta.labelKey as never) : op)}
              </button>
            );
          })}
        </div>
